...
public class ChatServer {
  ...
  public ChatServer () throws IOException {
    ...
    server.addListener(new Listener() {
      ...
      public void received (final Connection c, final Object object) {
        ...
        final ChatConnection connection = (ChatConnection)c;
    ...
    final JFrame frame = new JFrame("Chat Server");
  ...
  void updateNames () {
    ...
    final Connection[] connections = server.getConnections();
    final ArrayList names = new ArrayList(connections.length);
